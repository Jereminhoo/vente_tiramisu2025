...
-- Started on 2025-06-07 13:05:07
...
SELECT pg_catalog.setval('public.tiramisus_id_tiramisu_seq', 21, true);
...
SELECT pg_catalog.setval('public.utilsateurs_id_utilisateur_seq', 15, true);
...
--
-- TOC entry 4734 (class 2606 OID 16997)
-- Name: commandes commandes_id_utilisateur_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.commandes
    ADD CONSTRAINT commandes_id_utilisateur_fkey FOREIGN KEY (id_utilisateur) REFERENCES public.utilisateurs(id_utilisateur) ON DELETE CASCADE;


--
-- TOC entry 4735 (class 2606 OID 17002)
...
-- Completed on 2025-06-07 13:05:08
